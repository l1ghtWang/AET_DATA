...
data = pd.read_csv('AET_PIN_HIST_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
...
fig4 = plt.figure()
plt.bar(data3['reuse_time'],data3['counts'],width=my_width,color='b',align='edge')
plt.yscale("log")
