...
data = read.csv("AET_PIN_mcf_AUG8.out")
data1 = read.csv("AET_PIN_DROP_10_mcf_JAN21.out")
data2 = read.csv("AET_PIN_DROP_25_mcf_AUG8.out")
data3 = read.csv("AET_PIN_DROP_40_mcf_JAN21.out")
data4 = read.csv("AET_PIN_DROP_50_mcf_AUG8.out")
data5 = read.csv("AET_PIN_DROP_60_mcf_JAN21.out")
data6 = read.csv("AET_PIN_DROP_mcf_AUG8.out")
data7 = read.csv("AET_PIN_DROP_90_mcf_JAN21.out")
...
legend(9e+06,0.2,legend=c("original","10","25","40","50","60","dropped","90"), 
...
legend(9e+06,0.2,legend=c("original","D10","restored"), 
...
points(DATA2,col=3,lty=3, pch='.')
legend(9e+06,0.2,legend=c("original","D25","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(9e+06,0.2,legend=c("original","D40","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(9e+06,0.2,legend=c("original","D50","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(9e+06,0.2,legend=c("original","D60","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
points(DATA6,col=3,lty=3, pch='.')
legend(9e+06,0.2,legend=c("original","Drop","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(9e+06,0.2,legend=c("original","D90","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
