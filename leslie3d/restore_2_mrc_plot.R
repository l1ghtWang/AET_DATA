...
legend(250000,0.080,legend=c("original","10","25","40","50","60","dropped","90"), col=c(1,2,3,4,5,6,7,8), pch=c(16,16,16,16,16,16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_D10_restore_v2",sep=""),col=1,lty=1, pch='.')
points(data1,col=2,lty=3, pch='.')
points(DATA1,col=3,lty=3, pch='.')
legend(1500000,0.005,legend=c("original","D10","restored"), 
