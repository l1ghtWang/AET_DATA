...
data1 = read.csv("AET_PIN_DROP_10_perlbench_JAN21.out")
data2 = read.csv("AET_PIN_DROP_25_perlbench_SEP6.out")
data3 = read.csv("AET_PIN_DROP_40_perlbench_JAN21.out")
data4 = read.csv("AET_PIN_DROP_50_perlbench_SEP6.out")
data5 = read.csv("AET_PIN_DROP_60_perlbench_JAN21.out")
data6 = read.csv("AET_PIN_DROP_perlbench_SEP6.out")
data7 = read.csv("AET_PIN_DROP_90_perlbench_JAN21.out")
...
pdf(file=paste(benchmark,"_",section,"section_restore.pdf",sep=""))
