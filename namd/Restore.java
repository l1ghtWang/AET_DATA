...
{ 
  ...
  File file = new File("AET_PIN_namd_SEP2.out");
  File file2 = new File("AET_PIN_DROP_10_namd_JAN22.out");
  File file3 = new File("AET_PIN_DROP_25_namd_SEP2.out");
  File file4 = new File("AET_PIN_DROP_40_namd_JAN22.out");
  File file5 = new File("AET_PIN_DROP_50_namd_SEP2.out");
  File file6 = new File("AET_PIN_DROP_60_namd_JAN22.out");
  File file7 = new File("AET_PIN_DROP_namd_SEP2.out");
  File file8 = new File("AET_PIN_DROP_90_namd_JAN22.out");
