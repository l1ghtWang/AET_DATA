...
{ 
  ...
  File file = new File("AET_PIN_gromacs_AUG27.out");
  File file2 = new File("AET_PIN_DROP_10_gromacs_JAN21.out");
  File file3 = new File("AET_PIN_DROP_25_gromacs_AUG27.out");
  File file4 = new File("AET_PIN_DROP_40_gromacs_JAN21.out");
  File file5 = new File("AET_PIN_DROP_50_gromacs_AUG27.out");
  File file6 = new File("AET_PIN_DROP_60_gromacs_JAN21.out");
  File file7 = new File("AET_PIN_DROP_gromacs_AUG27.out");
  File file8 = new File("AET_PIN_DROP_90_gromacs_JAN21.out");
