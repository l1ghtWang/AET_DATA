...
data1 = pd.read_csv('AET_PIN_HIST_DROP_25_SP_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
data2 = pd.read_csv('AET_PIN_HIST_DROP_50_SP_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
data3 = pd.read_csv('AET_PIN_HIST_DROP_SP_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
