...
plot(data,main = benchmark,col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D10_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D25_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D40_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D50_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D60_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_drop_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
...
plot(data,main = paste(benchmark,"_",section,"section_D90_restore",sep = ""),col=1,ylim = c(0,0.3),lty=1, pch='.', xlim = c(0,262144))
