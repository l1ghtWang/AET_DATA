...
barplot(data1$counts,xlim=c(1,10000),names.arg = data1$reuse_time, main = paste(benchmark,"_hist_D25",sep=""),xlab ='reuse_time', ylab ='freq',log="x",offset=1)

barplot(data2$counts,xlim=c(1,10000),names.arg = data2$reuse_time,main = paste(benchmark,"_hist_Drop",sep=""),xlab ='reuse_time', ylab ='freq', log="xy",offset=1)
